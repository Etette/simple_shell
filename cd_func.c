...
/**
 * cd_path - function to return the path to change dir
 * @arg_list: arg_list from stdin
 * @envp: env linked list to find HOME and OLDPWD
 * @buf_size: size of the buffer
 * Return: the path to change. returns NULL if HOME or OLDPWD is not found
 */
