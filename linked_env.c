 ...
 * of the environmental variable linked list
 * @head: head of the linked list
 * @str: environmental variable value to store
 * Return: the address of the new element, exit if fail
 */
...
/**
 * update_env - updates an environmental variable
 * @envp: linked list of environmental variable
