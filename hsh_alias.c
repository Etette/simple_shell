...
/**
 * hsh_alias - buiutmin for alias function
 * @argv: vaector arguement
 * @env_p: env list
 * @mode: 0 || !0. execution mode for program
 * Return: 0 on success, 2 if fails
 */
...
/**
 * hsh_alias_search - find alias values matching thier key
...
/**
 * hsh_alias_print - print out a match found alias
 * @list: alias linked list
 * @argv: argument vector
 *
 * Return: 1 if no match needed, 2 if not found and 0 if success
 */
