...
/**
 * hsh_help - help command for hsh_shell builtin
 * @arg: argument lists
...
int hsh_help(char **arg)
{
	int i, size;
	builtin table[] = {
		{"exit", hsh_exit_help}, {"env", hsh_env_help}, {"setenv", hsh_setenv_help},
		{"unsetenv", hsh_unsetenv_help}, {"cd", hsh_cd_help}, {"help", hsh_help_help},
		{"alias", hsh_alias_help}, {"history", hsh_history_help}
	};
	if (arg[1] == NULL)
	{
