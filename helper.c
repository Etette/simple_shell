...
/**
 * print_cmdline - prints the cmd line or PS1
 */
...
/**
 * rm_vname - removes variable name of env variable
 * @envp: env variable name and value string
...
/**
 * get_env_value - get the value from an env variable
 * @envp: the env list
 * @name: key/name of the env variable
 * Return: pointer to the value, NULL if none found
 */
